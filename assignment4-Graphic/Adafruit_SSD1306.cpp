...
void Adafruit_SSD1306::send(uint8_t* adaFruitLogo)
{
    std::copy(
        adaFruitLogo, adaFruitLogo + (_rawHeight == 32 ? ((64 * 128 / 8)/2) : (64 * 128 / 8))
        , buffer.begin()
        );
}
