...
#include "font_5x7.h" // Header file included for using Font provided by CSE291
/******************CodeIT's Code for printing a single character *****************************/
void Adafruit_SSD1306::SingleChar(char c)
{
	int BufLen = 64*128/8;
	uint8_t CharBuff[BufLen];
	int i;
	for(i=0;i<BufLen;i++)
	{
